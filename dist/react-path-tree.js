...
var _filter2 = __webpack_require__(123);
...
var _find2 = __webpack_require__(124);

var _find3 = _interopRequireDefault(_find2);

var _get2 = __webpack_require__(35);

var _get3 = _interopRequireDefault(_get2);

var _sum2 = __webpack_require__(130);
...
var createId = function createId(layer, pageName) {
...
var flatData = function flatData(data) {
  ...
  function rec(node, pid, weightTotal) {
    ...
    var id = createId(layer, pageName);
    res[prop].push({
      layer: layer, pageName: pageName, weight: weight,
      id: id,
      type: type,
    ...
    if (children.length) children.sort(sorter).forEach(function (c) {
      return rec(c, id, total);
    });
  }
...
var PathTree = function (_React$Component) {
  _inherits(PathTree, _React$Component);

  function PathTree(props) {
    _classCallCheck(this, PathTree);

    var _this = _possibleConstructorReturn(this, (PathTree.__proto__ || Object.getPrototypeOf(PathTree)).call(this, props));

    _this.updateActive = function () {
      var data = _this.state.data;

      var id = (0, _get3.default)(data, '[0][0].id');
      var activeNodeIds = [id];
      _this.setState({ activeNodeIds: activeNodeIds }, _this.renderSvgDom);
    };

    _this.renderSvgDom = function () {
      var data = _this.state.data;
      var activeLayers = _this.state.activeLayers;

      var okIds = getOkIds(Math.min(activeLayers, data.length));
      return okIds.forEach(_this.updateSvgDom);
    };

    _this.updateSvgDom = function (info) {
      var _this$state = _this.state,
          data = _this$state.data,
          activeNodeIds = _this$state.activeNodeIds;
      var id = info.id,
          left = info.left,
          right = info.right;
      ...
      var startPoint = [0, computeHeight(height, marginBottom, index0)];
    ...
    _this.renderOther = function (rest, totalWeight, flat) {
      ...
      var weight = rest.reduce(function (prev, curr) {
    ...
    _this.nodeRender = function (arr, i) {
      var shouldRender = _this.state.activeLayers >= i + 1;
      if (!shouldRender) return null;
      var activeNodeIds = _this.state.activeNodeIds;

      var pid = i ? (0, _find3.default)(activeNodeIds, function (d) {
        return d.includes('layer' + i);
      }) : 'root';
      if (!pid) return null;
      var leave = (0, _find3.default)(arr, { type: 0, pid: pid });
      var filtered = (0, _filter3.default)(arr, { type: 1, pid: pid });
      var len = filtered.length;
      var top6 = filtered.slice(0, 6);
      var rest = filtered.slice(6, len);
  ...
  _createClass(PathTree, [{
    ...
    key: 'willComponentRecieveProps',
    value: function willComponentRecieveProps(nextProps) {}
  }, {
    key: 'render',
...
var DataView = __webpack_require__(44),
...
var arrayFilter = __webpack_require__(23),
    baseFilter = __webpack_require__(56),
    baseIteratee = __webpack_require__(18),
    isArray = __webpack_require__(3);
...
var createFind = __webpack_require__(80),
    findIndex = __webpack_require__(34);
...
var baseSum = __webpack_require__(72),
    identity = __webpack_require__(36);
